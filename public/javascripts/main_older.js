...
//   var filetarget = filetemp.target
//   var files = filetarget.files; //FileList object
//       for (var i = 0; i < files.length; i++) {
//           transcriptFile = files[i];
//           console.log("transcript read! Again!");
//       }

var output = '<ul style="font-family:helvetica;' + 
                         'font-size:10px">' + 
              escape(fileTemp.result) + 
              '</ul>';
...
// Calls the function to read transcript and create tagList
//$(document).ready(function(){
//    document.getElementById('files')
//            .addEventListener('change', handleFileSelect, false);
//});
//NOTE: This function no longer needed as the transcript loads on
//another page.
...
}); // end of document ready jquery function that takes care of all
    // the protocol tree stuff.
